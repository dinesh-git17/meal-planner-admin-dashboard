              ...
              <div className="relative">
                ...
                >
                  ...
                  {uniqueNames.map(name => {
                    const count = logs.filter(log => log.name === name).length
                    return (
        ...
        >
          {loading ? (
            ...
            >
              ...
              <span className="text-lg font-medium text-gray-600">Loading logs…</span>
            </motion.div>
                  ...
                  {expandedLogId === log.id && (
                    ...
                    >
                      {(['breakfast', 'lunch', 'dinner'] as const).map((mealType) => {
                        ...
                        const gptResponse = log[`${mealType}_gpt` as keyof MealLog] as string[] | null
                        
                        if (!meal && (!gptResponse || gptResponse.length === 0)) return null
                          ...
                          <div key={mealType} className="bg-gray-50/50 rounded-xl p-4">
                            ...
                            {meal && (
                              <div className="mb-3 pl-7">
                                <div className="text-sm font-medium text-gray-600 mb-1">Food Items:</div>
                                {renderMeal(meal)}
                              </div>
                            )}
                            ...
                            {gptResponse && gptResponse.length > 0 && (
                              <div className="pl-7">
                                <div className="text-sm font-medium text-pink-600 mb-1">AI Analysis:</div>
